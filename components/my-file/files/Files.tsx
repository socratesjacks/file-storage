...
const Files = (props: Props) => {
  ...
  return (
    <div className='flex flex-wrap gap-5'>
        ...
        {file.map((i) => (
            <div key={i.id} className='border relative rounded-md flex flex-col justify-between h-32 w-36  md:h-40 md:w-44'>
                ...
                <div className='p-3 flex flex-col h-full justify-between'>
                    ...
                    <div>
                        ...
                        <p className='text-[10px] font-semibold  text-slate-500'>{i.date}{' '}{i.time}</p>
                    </div>
                </div>    
