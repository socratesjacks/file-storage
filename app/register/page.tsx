    ...
    <section className='flex flex-col justify-center h-[90vh] items-center'>
        <div className='flex items-center gap-5 flex-col'>
            ...
            <div className='flex gap-2 flex-col'>
                <button className='w-64 h-10 text-white bg-[#186ade] rounded-md border py-2 text-xs px-1'>Sign Up</button>
                <button className='w-64 border-[#186ade] text-[#186ade] h-10 flex items-center justify-center gap-1 rounded-md border py-2 text-xs px-1'><AiOutlineGoogle  className='text-lg'/>Sign Up with Google</button>
            </div>
        </div>
        <p>or</p>
        <div className='flex flex-col items-center gap-2'>
            <div className='flex flex-col gap-1'>
                ...
                <input type='text' className='border-2 rounded-md py-2 outline-none px-1 text-xs w-64 h-10' placeholder='John Doe' />
            </div>
            <div className='flex flex-col gap-1'>
